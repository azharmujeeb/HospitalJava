<%-- 
    Document   : chatbot
    Created on : Apr 28, 2021, 2:07:48 PM
    Author     : azhar
--%>
   ...
   color:black;
    ...
    <body>
        ...
        border:none solid black;
         ...
         left: 403px;
          width: 884px;">        
        <input type="text" placeholder="Ask a question" onKeypress="enterButton(event, document.getElementsByTagName('input')[0].value);" onClick="answer(document.getElementsByTagName('input')[0].value)"  style="color:black;
         background-color:white; 
         width:79%;
         display: flex;
		flex-direction: row;
      ...
      <!-- <button onClick="answer(document.getElementsByTagName('input')[0].value)" 
      style="background: #B23AEE;
      left: 150px;"
      >send
    </button>  -->
    </p>
...
var you = "Me";
botSays("Let us know what we can help you with?")
